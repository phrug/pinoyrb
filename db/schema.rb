...
ActiveRecord::Schema.define(:version => 20130407123433) do
  ...
  add_index "contributors", ["contributable_id"], :name => "index_contributors_on_contributable_id"
  add_index "contributors", ["contributable_type"], :name => "index_contributors_on_contributable_type"
  ...
  add_index "entities", ["venue_id"], :name => "index_entities_on_venue_id"
  ...
  add_index "speakers", ["presentation_id"], :name => "index_speakers_on_presentation_id"
  ...
  add_index "sponsors", ["entity_id"], :name => "index_sponsors_on_entity_id"
